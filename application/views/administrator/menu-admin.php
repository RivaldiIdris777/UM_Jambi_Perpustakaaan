        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <?php
                $imageuser = $this->db->query("SELECT * FROM users where username='".$this->session->username."'")->row_array(); 
                if ($imageuser['foto'] == ''){ $foto ='users.gif'; }else{ $foto = $imageuser['foto']; }
                echo "<img class='img-circle' src='".base_url()."asset/foto_user/$foto'>"
              ?>
            </div>

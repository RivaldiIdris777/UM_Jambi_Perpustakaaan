<?php 
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart('administrator/edit_posterpublik',$attributes); 
              echo "<div class='col-md-12'>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type='text' class='form-control' name='judulposterpublik' value='$rows[judulposterpublik]'>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr><th scope='row'>Ganti Foto</th>
                    <td><input type='file' class='form-control' name='gambar'>";
                       if ($rows['gambar']!=''){ echo " Gambar Saat ini : <a target='_BLANK' href='".base_url()."asset/posterpublik/$rows[gambar]'>$rows[gambar]</a>"; } 
                    echo "</td>
                  </tr>
                </tbody>
                </table>

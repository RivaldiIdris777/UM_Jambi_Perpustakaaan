            ...
            <div class="row justify-content-center">
                <div class="col-xl-10 counter-inner">
                    <div class="card-group">
                        <div class="card col-md-4 m-2 rounded bg-warning">
                            <a href="https://jurnal.umjambi.ac.id/">
                                <img class="mx-auto d-block mt-3" src="<?php echo base_url()?>asset/frontends/images/e-journal.png" alt=""
                                    style="width: 30%;">
                        ...
                        <div class="card col-md-4 m-2 rounded bg-danger" style="padding-top: 33px;">
                            <a href="https://pustaka.umjambi.ac.id/">
                                <img class="mx-auto d-block" src="<?php echo base_url()?>asset/frontends/images/online-katalog.png" alt=""
                                    style="width: 40%;">
                                <div class="card-body text-center">
                        ...
                        <div class="card col-md-4 m-2 rounded bg-primary pt-4">
                            <a href="https://repository.umjambi.ac.id/">
                                <img class="mx-auto d-block" src="<?php echo base_url()?>asset/frontends/images/repository.png" alt=""
                                    style="width: 35%;">
                                <div class="card-body text-center">
        ...
        <div class="row">
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-4">
                    <div class="course-cat-icon">
                        <img src="<?php echo base_url()?>asset/frontends/images/icon/icon4.png" alt="" class="img-fluid">
                    </div>
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-1">
                    <div class="course-cat-icon">
                        <img src="<?php echo base_url()?>asset/frontends/images/icon/icon1.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-2">
                    <div class="course-cat-icon">
                        <img src="<?php echo base_url()?>asset/frontends/images/icon/icon2.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-3">
                    <div class="course-cat-icon">
                        <img src="<?php echo base_url()?>asset/frontends/images/icon/icon3.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-5">
                    <div class="course-cat-icon">
                        <img src="<?php echo base_url()?>asset/frontends/images/icon/icon6.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
...
<section class="work-process">
        <div class="row">
            <div class="col-xl-6" style="background-color: #800000;">
                <div class="container-fluid mt-5" style="margin-left: 30px;">
                    ...
                    <div class="card mb-5 mt-5 border-0" style="max-width: 540px; background-color: transparent !important">
                        <div class="row g-0">
                          <div class="col-md-2">
                            <img src="<?php echo base_url()?>asset/frontends/images/bookcollection.png" class="img-fluid rounded-start mt-4" alt="..." width="100">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h3 class="card-title text-light">Penyediaan Buku</h3>
                              <p class="card-text text-light">Memberikan layanan untuk meminjam buku yang ingin dibaca dan diakses di luar perkuliahan.</p> 
                            </div>
                          </div>
                        </div>
                      </div>                      
                      <div class="card mb-5 mt-5 border-0" style="max-width: 540px; background-color: transparent !important">
                        <div class="row g-0">
                          <div class="col-md-2">
                            <img src="<?php echo base_url()?>asset/frontends/images/roomlibrary.png" class="img-fluid rounded-start mt-4" alt="..." width="100">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h3 class="card-title text-light">Tempat Belajar</h3>
                              <p class="card-text text-light">Berkumpul dan belajar bersama dalam kerja kelompok atau mengerjakan tugas.</p> 
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-5 mt-5 border-0" style="max-width: 540px; background-color: transparent !important">
                        <div class="row g-0">
                          <div class="col-md-2">
                            <img src="<?php echo base_url()?>asset/frontends/images/computer.png" class="img-fluid rounded-start mt-4" alt="..." width="100">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h3 class="card-title text-light">Jurnal dan Referensi</h3>
                              <p class="card-text text-light">Membandingkan dan mencari jurnal sebagai referensi pengembangan dalam pembuatan skripsi ataupun jurnal untuk mahasiswa.</p> 
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="card mb-5 mt-5 border-0" style="max-width: 540px; background-color: transparent !important">
                        <div class="row g-0">
                          <div class="col-md-2">
                            <img src="<?php echo base_url()?>asset/frontends/images/wifi.png" class="img-fluid rounded-start mt-4" alt="..." width="100">
                          </div>
                          <div class="col-md-8">
                            <div class="card-body">
                              <h3 class="card-title text-light">Hotspot</h3>
                              <p class="card-text text-light">Menyediakan internet agar dapat mempermudah dalam belajar dan mencari tahu lebih luas.</p> 
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div class="col-xl-6" style="background-image: url(<?php echo base_url()?>asset/frontends/images/gedungsliceum.png); background-size: cover;">
            </div>
        </div>
    </section>
            ...
            <div class="col-lg-8 col-xl-8">
             ...
             <div class="col-xl-4 col-lg-4">
                <div class="text-center text-lg-end">
                    <a href="semuaberita" class="btn btn-main-outline rounded">Lihat Lebih Banyak <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-12">
                ...
                ?>
                    <a href="albums" class="btn btn-main-outline rounded">Lihat Lebih Banyak <i class="fa fa-angle-right"></i></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-4 col-lg-4">
                           <div class="cta-img mb-4 mb-lg-0">
                               <img src="<?php echo base_url()?>asset/frontends/images/akreditasi-perpustakaan-um-jambi-2021.jpeg" alt="" class="img-fluid">
                           </div>
                        </div>                        
                        <div class="col-xl-4 col-lg-4">
                            <div class="cta-img mb-4 mb-lg-0">
                                <img src="<?php echo base_url()?>asset/frontends/images/fppti-um-2021.jpeg" alt="" class="img-fluid">
                            </div>
                        </div>                        
                        <div class="col-xl-4 col-lg-4">
                            <div class="cta-img mb-4 mb-lg-0">
                                <img src="<?php echo base_url()?>asset/frontends/images/fpptma-um-2022.jpeg" alt="" class="img-fluid">
                            </div>
                        </div>                        
                    </div>
                </div>

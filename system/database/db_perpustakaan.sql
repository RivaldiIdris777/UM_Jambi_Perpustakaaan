...
--
-- Host: localhost:3306
-- Generation Time: Jan 05, 2024 at 07:26 AM
...
(371, 55, 'admin', 'Ruangan Public Pustakaan 02', 'ruangan-public-pustakaan-02', '', '<p>=</p>\r\n', 'IMG20200810144525.jpg'),
(372, 55, 'admin', 'Ruangan Public Pustakaan 03', 'ruangan-public-pustakaan-03', '', '<p>-</p>\r\n', 'IMG20201224124505.jpg'),
(370, 55, 'admin', 'Ruangan Public Pustakaan', 'ruangan-public-pustakaan', '', '<p>-</p>\r\n', 'IMG20200810144311.jpg');
...
(200, 0, 'Struktur Organisasi', 'page/detail/struktur-organisasi', 'Ya', 'Top', 6),
...
--
-- Table structure for table `posterpublik`
--

CREATE TABLE `posterpublik` (
  `id_posterpublik` int(11) NOT NULL,
  `judulposterpublik` varchar(255) DEFAULT NULL,
  `gambar` varchar(255) DEFAULT NULL,
  `link` varchar(255) DEFAULT NULL,
  `username` enum('admin','user') NOT NULL DEFAULT 'admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `posterpublik`
--

INSERT INTO `posterpublik` (`id_posterpublik`, `judulposterpublik`, `gambar`, `link`, `username`) VALUES
(5, 'Pengumuman', 'pengumuman.jpeg', '-', 'admin');
...
--
-- Table structure for table `pustakaluar`
--

CREATE TABLE `pustakaluar` (
  `id_pustakaluar` int(11) NOT NULL,
  `judulpustaka` varchar(255) DEFAULT NULL,
  `gambar` varchar(255) DEFAULT NULL,
  `link` varchar(255) DEFAULT NULL,
  `username` enum('admin','user') NOT NULL DEFAULT 'admin'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `pustakaluar`
--

INSERT INTO `pustakaluar` (`id_pustakaluar`, `judulpustaka`, `gambar`, `link`, `username`) VALUES
(1, 'Perpustakaan Nasional Republik Indonesia', 'logoperpusnas.png', 'https://www.perpusnas.go.id/', 'admin'),
(2, 'Indonesia One Search Perpus Logo', 'onesearchlogo.png', 'https://onesearch.id/', 'admin'),
(4, 'FFPTI', 'ffpti.png', 'https://fppti.or.id/v2/', 'admin'),
(6, 'LLDIKTI X', '1703831096_73f87f953cab9375fbd2.png', 'https://elibrary.lldikti10.id/', 'admin');
...
INSERT INTO `slider` (`id_slider`, `keterangan`, `gambar`, `kategori`, `username`) VALUES
(6, '<p>slider pertama</p>\r\n', 'sliderum01.png', 'Utama', 'admin');
...
--
-- Indexes for table `posterpublik`
--
ALTER TABLE `posterpublik`
  ADD PRIMARY KEY (`id_posterpublik`);
...
--
-- Indexes for table `pustakaluar`
--
ALTER TABLE `pustakaluar`
  ADD PRIMARY KEY (`id_pustakaluar`);
...
--
ALTER TABLE `gallery`
  MODIFY `id_gallery` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=373;
...
--
-- AUTO_INCREMENT for table `posterpublik`
--
ALTER TABLE `posterpublik`
  MODIFY `id_posterpublik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `pustakaluar`
--
ALTER TABLE `pustakaluar`
  MODIFY `id_pustakaluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
